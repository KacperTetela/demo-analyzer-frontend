...
const Account = () => {
    ...
    const handlePasswordChange = async (e) => {
        ...
        if (!currentPassword) {
            setMessage({ text: 'Wprowadź obecne hasło', type: 'error' });
            return;
        }
        ...
        try {
            ...
            if (success) {
                ...
                setMessage({ text: 'Obecne hasło jest nieprawidłowe', type: 'error' });
            }
        } catch (error) {
                ...
                <div className={`${styles.accountSection} ${styles.accountInfoSection}`}>
                    ...
                    <div className={styles.accountInfo}>
                        ...
                        <div className={styles.infoCard}>
                            ...
                            <div className={styles.infoContent}>
                                <div className={styles.infoLabel}>Data rejestracji</div>
                                <div className={styles.infoValue}>{userData.registrationDate}</div>
                            </div>
                        </div>
                        <div className={styles.infoCard}>
                            <div className={styles.infoIcon}>
